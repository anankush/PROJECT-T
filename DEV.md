# Project Developers & Contributors (DEV)

**Subject:** Data Communication & Networks Lab (Mini Project)  
**Project Name:** Travelstar Website & Automated FTP CI/CD Deployment Pipeline  
**Academic Year:** 2026  
...
Below is the list of team contributors and their academic roles, outlining their key contributions to this project:
...
| **Simi** | Technical Writer & Project Coordinator | <ul><li>Authored project introductory abstracts and documentation indices.</li><li>Researched client-server paradigms and protocol frameworks (HTTP/TCP).</li><li>Structured formatting for academic reports.</li></ul> |
